				...
				array(
					'main' => array(
						...
						'subscription_on_off'   => array(
							...
							'name'    => __( 'Subscription', 'essential-wp-real-estate' ),
							'type'    => 'select',
							'options' => array(
								'on' => __( 'On', 'essential-wp-real-estate' ),
								'off' => __( 'Off', 'essential-wp-real-estate' ),
							),
							'chosen'  => true,
							'std'     => 'on',
						),
						...
						'image_limit' => array(
							'id'   => 'image_limit',
							'name' => __( 'Image upload limit for the free listing plans', 'essential-wp-real-estate' ),
							'desc' => __( 'User Can upload the image in the add listing page gallery. Paid listings limit will be unlimited.', 'essential-wp-real-estate' ),
							'type' => 'number',
							'std'  => '5',
						),
