...
class Styles extends Condition {
	...
	public function enqueue_frontend_scripts() {
		...
		$image_limit = cl_admin_get_option( 'image_limit', '0' ) + 1;
		$limit_image = cl_admin_get_option( 'image_limit', '0' );
		...
		$ajax_var = array(
			...
			'add_listing_gallery_limit'  => __( "Can't upload over ", 'essential-wp-real-estate' ) . $limit_image . __(" photos for free plan", 'essential-wp-real-estate' ),
