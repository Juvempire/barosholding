	...
	public function cl_admin_login_html( $args = array() ) {
		...
		if(is_user_logged_in()){
			...
			$defaults          = array(
				...
				'label_username' => esc_html__( 'Username or Email','essential-wp-real-estate' ),
				'label_password' => esc_html__( 'Password','essential-wp-real-estate' ),
				'label_remember' => esc_html__( 'Remember Me','essential-wp-real-estate' ),
				'label_sign_in'  => esc_html__( 'Login','essential-wp-real-estate' ),
				'label_sign_up'  => esc_html__( 'Register','essential-wp-real-estate' ),
