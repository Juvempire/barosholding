			...
			<div class="singles-dashboard-list">
				...
				<div class="sd-list-right">
					...
					<div class="action">
						...
						<a href="<?php echo add_query_arg( 'cl_edit_listing_var', $single_post->ID, get_page_link( cl_admin_get_option( 'cl_edit_listing' ) ) ); ?>" data-toggle="tooltip" data-placement="top" title="Edit Property"><i class="fas fa-edit"></i> <?php echo esc_html__( 'Edit', 'essential-wp-real-estate' ); ?></a>
						<?php
